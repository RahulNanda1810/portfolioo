    ...
    <>
      ...
      <Section>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-text-secondary">
            I'm currently accepting new projects and collaborations. Whether you need a full product build, AI integration, or technical consultation—I'm here to help.
          </p>
        </div>
      </Section>
    </>
