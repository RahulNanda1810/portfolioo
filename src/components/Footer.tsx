...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border-light bg-surface">
      <div className="max-w-[1140px] mx-auto px-6 lg:px-8 py-12 md:py-16">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-text-secondary text-sm max-w-xs">
              AI & Full-Stack Product Engineer building intelligent systems and data-driven products.
            </p>
          </div>

          {/* Navigation */}
          <nav className="flex flex-wrap gap-6 md:gap-8">
            <Link to="/work" className="text-sm text-text-secondary hover:text-text-primary transition-colors">
              Work
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-border-light">
          <p className="text-text-tertiary text-sm text-center md:text-left">
            © {currentYear} Rahul Nanda. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
